...
df_A.rename(index=str, columns={'currency':'curr',
                               'Enterprise BU Desc':'BU',
                               'Invoice Fiscal Year Period Desc':'period',
...
df_with_A = pd.merge(df, temp_flat_DC, how='oute',
                    left_on= ['curr', 'BU', 'period'],
...
if len(not_in_map)>0:
    print('We have a mismatch between the bookings countries and the currency_map countries')
