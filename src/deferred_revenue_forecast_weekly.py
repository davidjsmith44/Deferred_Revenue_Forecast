...
import json
from deferred_revenue_functions_weekly import *
...
with open('period_config_weekly.json') as json_file:
...
with pd.ExcelWriter("../data/Data_2021_p03/processed/final/output.xlsx") as writer:
...
pickle.dump(saved_dict, open("../data/Data_2021_p03/processed/final/final_forecast_2.p", "wb"))
...
pickle.dump(input_df_dict, open("../data/Data_2021_p03/processed/final_forecast3.p", "wb"))
