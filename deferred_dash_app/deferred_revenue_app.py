    ...
    [
        ...
        html.Div(
            [
                dcc.Dropdown(
                    id="currency",
                    options=[{"label": i, "value": i} for i in list_currencies],
                    value="USD",
                ),
                dcc.RadioItems(
                    id="BU",
                    options=[{"label": i, "value": i} for i in list_BUs],
                    value="Creative",
        ...
        html.Div(
            [
                html.Div(dcc.Graph(id="deferred_1Y"), className="six columns"),
                html.Div(dcc.Graph(id="deferred_1M"), className="six columns"),
            ],
            className="row",
        ),
        html.Div(
            [
                html.Div(dcc.Graph(id="deferred_2Y"), className="six columns"),
                html.Div(dcc.Graph(id="deferred_6M"), className="six columns"),
            ],
            className="row",
        ),
        html.Div(
            [
                html.Div(dcc.Graph(id="deferred_3Y"), className="six columns"),
                html.Div(dcc.Graph(id="deferred_3M"), className="six columns"),
            ],
            className="row",
        ),
        html.Div(html.Div(dcc.Graph(id="deferred_all"), className="twelve columns")),
    ]
)
